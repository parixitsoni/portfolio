...
export const HeroProfile = () => {
  ...
  return (
    <div className="relative group p-4 cursor-pointer" onClick={toggleTheme}>
      ...
      <div className="relative w-64 h-72 md:w-80 md:h-[24rem] rounded-[3.5rem] relative z-10 transition-all duration-700 overflow-hidden group-hover:scale-[1.05]">
        <img
          src={getAssetPath("/parixit-bios-img.png")}
          alt="Parixit Soni"
          className={`w-full h-full object-cover transition-all duration-700 group-hover:scale-110 ${theme === 'dark' ? 'brightness-110' : 'brightness-100'}`}
        />
      </div>
